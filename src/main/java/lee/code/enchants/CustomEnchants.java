...
public class CustomEnchants {
    ...
    public final Enchantment LIFE_STEAL = new EnchantmentWrapper("life_steal", "Life Steal", 3, new Material[] {Material.ENCHANTED_BOOK, Material.BOOK, Material.NETHERITE_SWORD, Material.NETHERITE_AXE, Material.DIAMOND_SWORD, Material.DIAMOND_AXE, Material.GOLDEN_SWORD, Material.GOLDEN_AXE, Material.IRON_AXE, Material.IRON_SWORD, Material.WOODEN_SWORD, Material.WOODEN_AXE, Material.STONE_SWORD, Material.STONE_AXE });
    ...
    public void register() {
        List<Enchantment> customEnchants = Arrays.asList(LOGGER, DESTROYER, LIGHTNING_STRIKE, SOUL_BOUND, AUTO_SELL, SOUL_REAPER, LIFE_STEAL, MOLTEN_SHOT);
