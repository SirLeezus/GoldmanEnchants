...
public class CustomEnchants {
    ...
    public final Enchantment LOGGER = new EnchantmentWrapper("logger", "Logger", 0, new Material[] {Material.DIAMOND_AXE, Material.NETHERITE_AXE} );
    public final Enchantment DESTROYER = new EnchantmentWrapper("destroyer", "Destroyer", 0, new Material[] {Material.DIAMOND_PICKAXE, Material.NETHERITE_PICKAXE, Material.DIAMOND_SHOVEL, Material.NETHERITE_SHOVEL} );
    public final Enchantment LIGHTNING_STRIKE = new EnchantmentWrapper("lightning_strike", "Lightning Strike", 0, new Material[] {Material.DIAMOND_SWORD, Material.NETHERITE_SWORD} );
    public final Enchantment SOUL_BOUND = new EnchantmentWrapper("soul_bound", "Soul Bound", 0, new Material[] {Material.TRIDENT, Material.DIAMOND_SHOVEL, Material.NETHERITE_SHOVEL, Material.DIAMOND_AXE, Material.NETHERITE_AXE, Material.DIAMOND_HOE, Material.NETHERITE_HOE, Material.DIAMOND_SWORD, Material.NETHERITE_SWORD, Material.DIAMOND_PICKAXE, Material.NETHERITE_PICKAXE, Material.DIAMOND_CHESTPLATE, Material.NETHERITE_CHESTPLATE, Material.DIAMOND_HELMET, Material.NETHERITE_HELMET, Material.DIAMOND_LEGGINGS, Material.NETHERITE_LEGGINGS, Material.DIAMOND_BOOTS, Material.NETHERITE_BOOTS} );
    public final Enchantment AUTO_SELL = new EnchantmentWrapper("auto_sell", "Auto Sell", 0, new Material[] {Material.DIAMOND_HOE, Material.NETHERITE_HOE} );
